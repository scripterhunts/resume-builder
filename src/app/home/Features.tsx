...
const FEATURES = [
  {
    src: featureFreeSrc,
    title: "Free Forever",
    text: "Seewee is created with the belief that everyone should have free and easy access to a modern professional resume design",
  },
  {
    src: featureUSSrc,
    title: "Best Practices",
    text: "Seewee has built-in best practices for the job market and works well with top ATS platforms such as Greenhouse and Lever",
  },
  {
    src: featurePrivacySrc,
    title: "Privacy Focus",
    text: "SeeWee stores data locally in your browser so only you have access to your data and with complete control",
  },
