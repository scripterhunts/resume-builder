...
const getHTMLFromBulletListStrings = (bulletListStrings: string[] | string | null) => {
  // If bulletListStrings is null or undefined, return an empty div
  if (!bulletListStrings) {
    return "<div></div>";
  }

  // If bulletListStrings is a string, convert it to an array
  if (typeof bulletListStrings === 'string') {
    bulletListStrings = [bulletListStrings];
  }

  // Now bulletListStrings is guaranteed to be string[]
