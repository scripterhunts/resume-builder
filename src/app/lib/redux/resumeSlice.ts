...
export type ChangeDescriptionsActionPayload = {
  idx: number;
  descriptions: string[];
};
...
export const resumeSlice = createSlice({
  ...
  reducers: {
    ...
    changeWorkExperienceDescriptions: (
      state,
      action: PayloadAction<ChangeDescriptionsActionPayload>
    ) => {
      const { idx, descriptions } = action.payload;
      state.workExperiences[idx].descriptions = descriptions;
    },
    changeEducations: (
      draft,
